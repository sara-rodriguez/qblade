...
private:
    double m_reynolds, m_alpha, x, m_rot_speed, m_u_wind_speed, m_TSRtd, m_obs_x_pos, m_obs_y_pos, m_obs_z_pos, m_mach,  m_obs_x_pos_rotor, m_obs_y_pos_rotor, m_obs_z_pos_rotor, m_tower_to_hub_distance, m_tower_to_rotor_distance, m_initial_azimuth, m_time, m_shear_roughness, m_shear_height, m_shear_speed, m_yaw_angle, m_valRel_TE, m_valReu_TE, m_valMal_TE, m_valMau_TE, m_valAOAl_TE, m_valAOAu_TE, m_valRel_LE, m_valReu_LE, m_valMal_LE, m_valMau_LE; //Sara
	OpPoint *m_opPoint;
//Sara
