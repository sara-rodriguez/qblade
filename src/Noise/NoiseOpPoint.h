...
private:
	...
	OpPoint *m_opPoint;
//Sara
bool m_rot_speed_check, m_u_wind_speed_check, m_TSR_check, m_shear_check, m_valRel_TE_check, m_valReu_TE_check, m_valMal_TE_check, m_valMau_TE_check, m_valAOAl_TE_check, m_valAOAu_TE_check, m_valRel_LE_check, m_valReu_LE_check, m_valMal_LE_check, m_valMau_LE_check, m_autopolars_check, m_vegetation_check, m_atm_check;
int m_Lowson_type, m_number_loops, m_timesteps, m_qs3DSim, m_valPsil_check, m_valPsiu_check, m_vegetation, m_LE_check;
//Sara
};
