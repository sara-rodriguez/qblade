...
private:
    double m_reynolds, m_alpha, m_sects, x, m_rot_speed, m_u_wind_speed, m_TSRtd, m_dstar_user, m_rot_speed_calc, m_u_wind_speed_calc, m_TSR_calc, m_obs_x_pos, m_obs_y_pos, m_obs_z_pos, m_mach, m_Tt, m_obs_x_pos_rotor, m_obs_y_pos_rotor, m_obs_z_pos_rotor; //Sara
	OpPoint *m_opPoint;
//Sara
