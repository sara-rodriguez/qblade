...
{
public:
    enum GraphArrangement {Single, Vertical, Vertical3, Horizontal, Quad, QuadVertical, Quint}; //Sara
    ...
    NewGraph *m_graph[5];  // it's up to the module to allocate the graphs //Sara
